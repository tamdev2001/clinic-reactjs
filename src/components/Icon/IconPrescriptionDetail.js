...
const IconPrescriptionDetail = () => {
    return (
		...
		c-4.8,0-8.8-3.9-8.8-8.8V45.5z"
            />
            <path
                d="M12.6,28.1c2.6,0,4.8,2.1,4.8,4.8c0,0.6,0.4,1,1,1c0.6,0,1-0.4,1-1c0-3.7-3-6.8-6.8-6.8c-0.6,0-1,0.4-1,1
		S12,28.1,12.6,28.1z"
            />
        </svg>
    );
...
export default IconPrescriptionDetail;
